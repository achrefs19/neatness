...
class MapNeatness extends StatefulWidget {
  const MapNeatness({super.key});

  @override
  State<MapNeatness> createState() => _MapNeatnessState();
}

class _MapNeatnessState extends State<MapNeatness> with TickerProviderStateMixin {
  ...
  void _animatedMapMove(LatLng destLocation, double destZoom) {
    ...
    controller.forward();
//    mapController.pointToLatLng(screenPoint)
  }
            ...
            children: [
              ...
              Positioned(
                ...
                child: PageView.builder(
                  ...
                  onPageChanged: (value) {
                    selectedIndex = value;
                    currentLocation = mapMarkers[value].location ?? LatLng(10.0, 10.0);
                ...
                markers: [
                  for (int i = 0; i < mapMarkers.length; i++)
                    Marker(
                      height: 40,
                      width: 40,
                      point: mapMarkers[i].location ?? LatLng(10.0, 10.0),
                      builder: (_) {
